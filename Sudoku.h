...
/*
 * Sudoku.h
 * Name: Harry Kran-Annesxtein
 *
 * Definition for the Sudoku class.
 *
 * Oct 23, 2013
 */
...
public:
  ...
  bool checkTest(vector<int> t);

  vector<int> getRegion(int y, int x, const board_t &state);
...
private:
  ...
  bool solve(board_t state);  // Internal recursive solve function
